    ...
    <article className="cs180-project-page cs180-project-one">
      ...
      <section className="cs180-section">
        ...
        <div className="cs180-section-copy">
          ...
          <p>At each larger level, I test shifts from −2 to +2 pixels around the previous estimate, giving 25 combinations per channel. When shrinking the images, I use anti-aliasing to reduce jagged edges and unwanted patterns. I also leave out at least 10% of the image along each edge when scoring a shift, increasing that margin if needed to exclude pixels that wrap around from the opposite edge. Finally, I run the pyramid algorithm on the three smaller JPEGs and get the same results as the single-scale method.</p>
        </div>
